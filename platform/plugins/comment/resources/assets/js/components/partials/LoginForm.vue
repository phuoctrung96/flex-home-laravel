<template>
    ...
    >
        <div slot="header">
            ...
            <p class="text-gray">
                {{ __("Use your credentials to access your account.") }}
            </p>
        </div>
        ...
        <div slot="footer">
            ...
            >
                <div>
                    <button type="button" class="btn btn-warning btn-block" @click="AuthProvider('facebook')">
            ...
            <div
                v-if="loginWithGuards && loginWithGuards.length"
                class="bb-comment-login-with-guards"
            >
                <hr />
                ...
                <div class="guards-container">
                    <div
                        v-for="user in loginWithGuards"
                        :key="user.key"
                        @click="onLoginWithGuard(user)"
                        class="item"
                    >
...
export default {
    ...
    methods: {
        ...
        onSubmit(e) {
            ...
            Http.post(
                !this.isRegistering ? this.loginUrl : this.registerUrl,
                formData
